...
def start_test(parameters, filename):
    ...
    experiment_name = f"{filename}_population_pmx"
    ...
    plt.plot(np.array(numbers), np.array(all_costs)[6],
             linestyle='-', color='g', label=f'{parameters[6]["population size"]}_s_pmx')
    plt.plot(np.array(numbers), np.array(all_costs)[7],
             linestyle='--', color='g', label=f'{parameters[7]["population size"]}_s_pmx')
    plt.plot(np.array(numbers), np.array(all_costs)[8],
             linestyle='-.', color='g', label=f'{parameters[8]["population size"]}_s_px')

    plt.plot(np.array(numbers), np.array(all_costs)[9],
             linestyle='-', color='k', label=f'{parameters[9]["population size"]}_i_pmx')
    plt.plot(np.array(numbers), np.array(all_costs)[10],
             linestyle='--', color='k', label=f'{parameters[10]["population size"]}_i_pmx')
    plt.plot(np.array(numbers), np.array(all_costs)[11],
             linestyle='-.', color='k', label=f'{parameters[11]["population size"]}_i_pmx')
    ...
    plt.savefig(f"{filename}_diff_pop.png", format='png', bbox_inches='tight')
    plt.show()
